...
export const LogicaJogoMemoriaContext = createContext();

export const LogicaJogoMemoriaContextProvider = ({ children }) => {
  ...
  return (
    <LogicaJogoMemoriaContext.Provider value={valor}>
      {children}
    </LogicaJogoMemoriaContext.Provider>
  );
};